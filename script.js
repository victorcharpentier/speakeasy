...
recognition.onresult = (event) => {
  ...
  document.getElementById('resultat').innerHTML = finalTranscript + interimTranscript;
  ...
  fetch(url)
    ...
    .then(data => {
      document.getElementById('resultatTraduit').innerHTML = data.translations[0].text;
      if (!isSpeaking) {
